...
const CreditCard = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        if (response.status === 200) {
          setLocumMin1(response.data.plans.locumMin1);
          setLocumMax1(response.data.plans.locumMax1);
          setLocumFee1(response.data.plans.locumFee1);
          setLocumDiscount1(response.data.plans.locumDiscount1);
          setLocumMin2(response.data.plans.locumMin2);
          setLocumMax2(response.data.plans.locumMax2);
          setLocumFee2(response.data.plans.locumFee2);
          setLocumDiscount2(response.data.plans.locumDiscount2);
          setLocumMin3(response.data.plans.locumMin3);
          setLocumMax3(response.data.plans.locumMax3);
          setLocumFee3(response.data.plans.locumFee3);
          setLocumDiscount3(response.data.plans.locumDiscount3);
          setLocumMin4(response.data.plans.locumMin4);
          setLocumMax4(response.data.plans.locumMax4);
          setLocumFee4(response.data.plans.locumFee4);
          setLocumDiscount4(response.data.plans.locumDiscount4);
          setLocumMin5(response.data.plans.locumMin5);
          setLocumMax5(response.data.plans.locumMax5);
          setLocumFee5(response.data.plans.locumFee5);
          setLocumDiscount5(response.data.plans.locumDiscount5);
          setLocumMin6(response.data.plans.locumMin6);
          setLocumMax6(response.data.plans.locumMax6);
          setLocumFee6(response.data.plans.locumFee6);
          setLocumDiscount6(response.data.plans.locumDiscount6);
          setLocumMin7(response.data.plans.locumMin7);
          setLocumMax7(response.data.plans.locumMax7);
          setLocumFee7(response.data.plans.locumFee7);
          setLocumDiscount7(response.data.plans.locumDiscount7);
          setLocumMin8(response.data.plans.locumMin8);
          setLocumMax8(response.data.plans.locumMax8);
          setLocumFee8(response.data.plans.locumFee8);
          setLocumDiscount8(response.data.plans.locumDiscount8);
          setLocumMin9(response.data.plans.locumMin9);
          setLocumMax9(response.data.plans.locumMax9);
          setLocumFee9(response.data.plans.locumFee9);
          setLocumDiscount9(response.data.plans.locumDiscount9);
          setLocumPayment(response.data.plans.locumPayment);
        }
      });
  }, [noDays]);
