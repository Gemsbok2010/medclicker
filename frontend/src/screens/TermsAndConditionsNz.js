  ...
  return (
    <>
      <HelmetProvider>
        ...
        <div className="wrap">
          <div className="tnc">
            <h2 className="nonselect">Terms & Conditions New Zealand</h2>
          </div>
          <section className="agreeContent container nonselect">
            <p>
              <Link to="/terms_and_conditions_au">
                See Terms & Conditions for Australia
              </Link>
            </p>
            <br />
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                Website in a manner which abides by all applicable laws of New
                Zealand, or of any other relevant jurisdiction (including,
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    5.1.1 Employment Relations Act 2000 including but not
                    limited to section 4, which requires that if you are a
                    company you must not mislead persons seeking employment as
                    to the availability, nature, terms or conditions or, any
                    other matter relating to the employment opportunity being
                    offered;
                  </li>
                  <li>
                  ...
                  <li>
                    5.1.3 Privacy Act 1993, including the New Zealand
                  ...
                  <li>
                    5.1.5 Human Rights Act 1993 and Employment Relations Act
                    2000; and
                  </li>
                  <li>
                    5.1.6 All anti-discrimination and equal opportunity
                    legislation application in New Zealand which you do
                    business.
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                any location outside of New Zealand without MedClicker's express
            ...
            <p>
              ...
              accordance with the laws of New Zealand, and application for any
              of the services offered on these pages or sites will constitute
              your consent and submission to the jurisdiction of New Zealand
              Courts regarding all proceedings, transactions, applications or
              the like instituted by either party against the other, arising
              from any of the terms and conditions pertaining to such services.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                that term is defined in the Privacy Act 1993 (Cth)), all data
              ...
              <li>
                ...
                Privacy Act 1993 of any candidate that you obtain through your
                use of the MedClicker Website or products offered on the Site
                (including job applications received from candidates) must be
                only used by you in relation to your genuine employment and/or
              ...
              <li>
                ...
                1993 and NZ Information Privacy Principles (NZ IPPs) extremely
                seriously, and is resolute in its determination to prevent the
                misuse of candidate data. If MedClicker believes that you have
                misused candidate data for any reason, MedClicker reserves the
                right to:
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    Act 1993 by you to the relevant authorities; and/or
                  </li>
                  <li>
            ...
            <ul>
              ...
              <li>
                13.5 You agree that pursuant to the Privacy Act 1993, MedClicker
                may obtain from either a credit reporting agency or other credit
                providers personal credit information about you and/or your
                directors or a consumer credit report about you for the purpose
                of collecting overdue payments relating to commercial credit
                owed by you. You also agree that MedClicker disclose this
                information to a credit reporting agency or any other interested
                person.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                ...
                of MedClicker, in-line with the New Zealand Consumer Guarantees
                Act 1993.{" "}
              </li>
            </ul>
            <h4>15.COPYRIGHT</h4>
            ...
            <ul>
              ...
              <li>
                ...
                Advertisers irrevocably and unconditionally submit to the
                exclusive jurisdiction of the Courts of New Zealand, and waive
...
export default TermsAndConditionsNz;
