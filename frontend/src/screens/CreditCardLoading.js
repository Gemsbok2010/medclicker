...
const CreditCardLoading = () => {
  ...
  const nanoslug = pathname.split("payment_loading/")[1];
          ...
          if (data) {
            setTimeout(function () {
              ReactGA.event({
                ...
                action: "Locum Ad Payment Completed",
                value: TotalAmount,
              });
  ...
  const locumNotification = async (Email) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (
          ...
          ReactSession.set("accessCode", "");
          ReactSession.remove("accessCode");
          ...
          setTimeout(function () {
            ...
            ReactGA.event({
              category: "Post Locum Ad",
              action: "Locum Ad Payment failed",
            });
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Locum Payment Loading... | Medclicker</title>
