      ...
      <HelmetProvider>
        ...
        <div className="wrap">
          <div className="refund">
            <h2 className="nonselect">Refund Policy - Australia</h2>
          </div>
          <section className="agreeContent container nonselect">
            <p>
              <Link to="/refund_nz">See Refund Policy for New Zealand</Link>
            </p>
            <br />
            ...
            <ul>
              ...
              <li>
                ...
                It will then take an additional 4–5 business days for the refund
                to show in your account. Refunds may take longer to process
                during sales periods or for international returns.
              </li>
              <li>
              ...
              <li>
                ...
                MedClicker, in-line with the Australian Competition and Consumer
                Commission's published policies and guidelines. More information
                can be found at{" "}
                <Link target="_blank" to="http://www.accc.gov.au/consumers/">
