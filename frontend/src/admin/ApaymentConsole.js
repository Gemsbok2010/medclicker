...
const ApaymentConsole = () => {
  ...
  const onStore = async (e) => {
    ...
    const res = await fetch(
      process.env.REACT_APP_BACKEND_URL + "api/payments_plans/plans",
      {
        method: "PUT",
        credentials: "include",
  ...
  const enableLocum = async (e) => {
    ...
    if (locumPayment === true) {
      setBackdrop(true);
      const res = await fetch(
        process.env.REACT_APP_BACKEND_URL + "api/payments_plans/enableLocum",
        {
          method: "PUT",
          credentials: "include",
          headers: { "Content-type": "application/json" },
  ...
  const enablePayment = async (e) => {
    ...
    if (regularPayment === true) {
      setBackdrop(true);
      const res = await fetch(
        process.env.REACT_APP_BACKEND_URL + "api/payments_plans/enablePayment",
        {
          method: "PUT",
          credentials: "include",
          headers: { "Content-type": "application/json" },
