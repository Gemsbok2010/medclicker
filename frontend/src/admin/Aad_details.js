  ...
  const onSubmit = (e) => {
    ...
    fetch(
        ...
        expiryDate,
      {
        ...
        body: JSON.stringify({
          // applicant (12)
          firstName: mimicUser.firstName,
          lastName: mimicUser.lastName,
          nanoId: mimicUser.nanoId,
          photo: idPhoto,
          phone: mimicUser.phone,
          isLocum: mimicUser.isLocum,
          email: mimicUser.email,
          locum_ahpra: ahpra,
