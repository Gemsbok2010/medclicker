...
const AlistingsEdit = () => {
  ...
  const [normal_rate, setNormalRate] = useState(null);
  const [sat_rate, setSatRate] = useState(null);
  const [sun_rate, setSunRate] = useState(null);
  const [ph_rate, setPhRate] = useState(null);
          ...
          <div className="edit-description">
            ...
            <form action="" onSubmit={onSubmit}>
              ...
              <div className="bottomButtons">
                ...
                {/* ADMIN CAN EDIT UNTIL LISTING EXPIRES */}
                {/* USER CAN EDIT UNTIL PAYMENT */}
                {isDeleted === false ? (
                  monFinish ||
                  tueFinish ||
                  wedFinish ||
